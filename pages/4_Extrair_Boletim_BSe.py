...
def extrair_atos_normativos_html(texto_html: str) -> List[Dict[str, str]]:
    ...
    for idx, bloco_html in enumerate(matches):
        ...
        # 1. Inferir Cargo pela Sigla no Título
        cargo_autoridade = ""
        ...
        # 2. Tentar encontrar o Nome da Autoridade pela assinatura "(a) NOME"
        nome_autoridade = ""
    ...
    if not atos:
        ...
        for ato in atos:
            with st.expander(f"📄 {ato['titulo']}", expanded=False):
                ...
                # Campos de Assinatura e Dados Extras (Individuais por Ato)
