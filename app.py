...
if not st.session_state.autenticado:
    ...
    <style>
        ...
        [data-testid="stForm"] { max-width: 420px; margin: 4rem auto; padding: 2.5rem; background: #ffffff; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.08); border: 1px solid #f1f5f9; }
